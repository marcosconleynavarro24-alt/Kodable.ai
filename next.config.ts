...
// Sensible security headers for a static marketing site. next/font self-hosts the
// fonts, so no external font/style/script origins are needed. We allow inline
