...
const en: SiteContent = {
  ...
  hero: {
    headingPre: "Getting ",
    headingHi: "found",
    headingMid: " is half of it. ",
    headingHi2: "Answering",
    headingPost: " is the other half.",
...
const es: SiteContent = {
  ...
  hero: {
    headingPre: "Que te ",
    headingHi: "encuentren",
    headingMid: " es la mitad. ",
    headingHi2: "Responder",
    headingPost: " es la otra mitad.",
...
const fr: SiteContent = {
  ...
  hero: {
    headingPre: "Être ",
    headingHi: "trouvé",
    headingMid: ", c'est la moitié. ",
    headingHi2: "Répondre",
    headingPost: ", c'est l'autre moitié.",
...
const de: SiteContent = {
  ...
  hero: {
    headingPre: "",
    headingHi: "Gefunden",
    headingMid: " werden ist die eine Hälfte. ",
    headingHi2: "Antworten",
    headingPost: " ist die andere Hälfte.",
...
const it: SiteContent = {
  ...
  hero: {
    headingPre: "Farsi ",
    headingHi: "trovare",
    headingMid: " è metà del lavoro. ",
    headingHi2: "Rispondere",
    headingPost: " è l'altra metà.",
