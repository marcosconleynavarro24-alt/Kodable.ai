    ...
    >
      <div className="grid grid-cols-4 md:grid-cols-12 gap-8 items-end mb-24">
        ...
        <div className="col-span-4 md:col-span-6 md:text-right">
          <p className="text-ink-muted max-w-[400px] ml-auto text-[16px] leading-[1.6]">
      ...
      <div className="grid grid-cols-4 md:grid-cols-12 gap-8 border-t border-line pt-12">
        {processSteps.map((step) => (
          ...
          >
            <span
              className="absolute -top-12 left-0 text-[120px] font-normal text-line/40 -z-10 transition-colors duration-500 group-hover:text-accent/10 leading-none"
              style={{ fontFamily: "var(--font-serif)" }}
            >
              {step.number}
            </span>
